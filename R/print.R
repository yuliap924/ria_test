...
print_te <- function(x) {
	...
	cli::cli_text(cat("      "), "{.strong Estimate}: {round(x$estimates$ate, 4)}")
	cli::cli_text(cat("    "), "{.strong Std. error}: {round(calc_stderror(x$estimates$eif_ate, x$id, x$weights), 4)}")
	cli::cli_text(cat("        "), "{.strong 95% CI}: ({round(calc_ci(x$estimates$ate, x$estimates$eif_ate, x$id, x$weights)[1][1], 4)}, {round(calc_ci(x$estimates$ate, x$estimates$eif_ate, x$id, x$weights)[1][2], 4)})")
	cli::cli_text(cat("        "), "{.strong 90% CI}: ({round(calc_ci(x$estimates$ate, x$estimates$eif_ate, x$id, x$weights)[2][1], 4)}, {round(calc_ci(x$estimates$ate, x$estimates$eif_ate, x$id, x$weights)[2][2], 4)})")
	cli::cli_text(cat("        "), "{.strong 99% CI}: ({round(calc_ci(x$estimates$ate, x$estimates$eif_ate, x$id, x$weights)[3][1], 4)}, {round(calc_ci(x$estimates$ate, x$estimates$eif_ate, x$id, x$weights)[3][2], 4)})")
	...
	cli::cli_text(cat("        "), "{.strong 95% CI}: ({round(calc_ci(x$estimates$rate, x$estimates$eif_rate, x$id, x$weights)[1][1], 4)}, {round(calc_ci(x$estimates$rate, x$estimates$eif_rate, x$id, x$weights)[1][2], 4)})")
	cli::cli_text(cat("        "), "{.strong 90% CI}: ({round(calc_ci(x$estimates$rate, x$estimates$eif_rate, x$id, x$weights)[2][1], 4)}, {round(calc_ci(x$estimates$rate, x$estimates$eif_rate, x$id, x$weights)[2][2], 4)})")
	cli::cli_text(cat("        "), "{.strong 99% CI}: ({round(calc_ci(x$estimates$rate, x$estimates$eif_rate, x$id, x$weights)[3][1], 4)}, {round(calc_ci(x$estimates$rate, x$estimates$eif_rate, x$id, x$weights)[3][2], 4)})")
	...
	cli::cli_text(cat("        "), "{.strong 95% CI}: ({round(calc_ci(x$estimates$ate_rate_diff, x$estimates$eif_ate_rate_diff, x$id, x$weights)[1][1], 4)}, {round(calc_ci(x$estimates$ate_rate_diff, x$estimates$eif_ate_rate_diff, x$id, x$weights)[1][2], 4)})")
	cli::cli_text(cat("        "), "{.strong 90% CI}: ({round(calc_ci(x$estimates$ate_rate_diff, x$estimates$eif_ate_rate_diff, x$id, x$weights)[2][1], 4)}, {round(calc_ci(x$estimates$ate_rate_diff, x$estimates$eif_ate_rate_diff, x$id, x$weights)[2][2], 4)})")
	cli::cli_text(cat("        "), "{.strong 99% CI}: ({round(calc_ci(x$estimates$ate_rate_diff, x$estimates$eif_ate_rate_diff, x$id, x$weights)[3][1], 4)}, {round(calc_ci(x$estimates$ate_rate_diff, x$estimates$eif_ate_rate_diff, x$id, x$weights)[3][2], 4)})")
